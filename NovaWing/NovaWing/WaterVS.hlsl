...
static const float wave_height2 = 30.0f; //波の高さ
...
VS_OUTPUT main(VS_INPUT input)
{
    ...
    -(derivateveWaveX + dDiagonalWaveX + dRippleWaveX + dWhiteWaveX), //X成分を持つ波
    1.0f,
    -(derivateveWaveZ + dDiagonalWaveZ + dRippleWaveZ + dWhiteWaveZ) //Z成分を持つ波
    ));
